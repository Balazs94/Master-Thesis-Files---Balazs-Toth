 ...
 * @author balaz
 */
public class MAPEvolutionFullMap extends LogTool {

    public MAPEvolutionFullMap() {
    }
            ...
            for (MapElitesCell c : cells) {
                ...
                if (ind instanceof MEIndividual || ind == null) {
                    ...
                    if (c.isItFilled()) {
                        ...
                        individual_str += "(BF:" + meIndividual.getBehavioralFeatures().get(0) + " BF:" + meIndividual.getBehavioralFeatures().get(1) + ") location: " + c.getLocation() + "Fitness: " + meIndividual.getFitness();
                    } else {
                        individual_str += "location" + c.getLocation();
                    }
                    if (c.isItFilled()) {
